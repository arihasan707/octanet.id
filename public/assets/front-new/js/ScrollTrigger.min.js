        ...
        if (i) {
            ...
            (p = "scroll" + n.d2),
                Y(
                    ...
                    (S && 20 < _) ||
                        (!S &&
                            (u ? Math.max(et[p], Ue[p]) : i.parentNode[p]) <=
                                _ + 1)
                ),
                u &&
                    ((l = Mt(a)),
        ...
        Bt = function _setState(e) {
            if (e) {
                var t,
                    ...
                    i = 0;
                for (
                    (e.t._gsap || qe.core.getCache(e.t)).uncache = 1;
                    i < o;
                    i += 2
                )
                    (r = e[i + 1]),
            ...
            ((ScrollTrigger.prototype.init = function init(S, T) {
                if (
                    ...
                    var k,
                        ...
                        i,
                        Z = (S = fb(
                            Ja(S) || La(S) || S.nodeType ? { trigger: S } : S,
                            Ct
                        )).onUpdate,
                        $ = S.toggleClass,
                        a = S.id,
                        ...
                        we = be
                            ? 0
                            : parseFloat(db(ve)["border" + ge.p2 + At]) || 0,
                        _e = this,
                        Se =
                            S.onRefreshInit &&
                            function () {
